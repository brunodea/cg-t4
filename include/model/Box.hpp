...
namespace model
{
    ...
    private:
        ...
        void drawQuads()
        {
            ...
            math::Vector3 normal = math::normalize(v.crossProduct(v3));
            ...
            normal = math::normalize(v.crossProduct(v6));
            glNormal3f(normal[0],normal[1],normal[2]);
            glVertex3f(v[0],v[1],v[2]);
            ...
            normal = math::normalize(v2.crossProduct(v7));
            glNormal3f(normal[0],normal[1],normal[2]);
            glVertex3f(v2[0],v2[1],v2[2]);
            glVertex3f(v6[0],v6[1],v6[2]);
            ...
            normal = math::normalize(v3.crossProduct(v8));
            glNormal3f(normal[0],normal[1],normal[2]);
            glVertex3f(v3[0],v3[1],v3[2]);
            glVertex3f(v7[0],v7[1],v7[2]);
            ...
            normal = math::normalize(v.crossProduct(v8));
            glNormal3f(normal[0],normal[1],normal[2]);
            glVertex3f(v[0],v[1],v[2]);
            glVertex3f(v5[0],v5[1],v5[2]);
            glVertex3f(v8[0],v8[1],v8[2]);
            ...
            normal = math::normalize(v5.crossProduct(v7));
            glNormal3f(normal[0],normal[1],normal[2]);
            glVertex3f(v5[0],v5[1],v5[2]);
            glVertex3f(v6[0],v6[1],v6[2]);
            glVertex3f(v7[0],v7[1],v7[2]);
